...
if __name__=="__main__":
    ...
    parser.add_argument('-f', '--function', type=str, required=True, choices=['toCsv', 'byIp', 'byUri','byStatus','bySize', 'byTag', 'byArg'], help='The function which is executed')
